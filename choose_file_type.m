...
handles.output.ge=0;
handles.output.sample_type='';
handles.output.genome='';
...
set(hObject,'String',{'Select data type...','ENTREZ IDs','RefSeq accession','Gene symbols'})
...
contents = cellstr(get(hObject,'String'));
handles.output.genome = contents{get(hObject,'Value')};
...
set(hObject,'String',{'Select organism...','Homo sapiens','Mus musculus'})
